//
//  CICQuadChartiPadViewController.h
//  ChariotGauge
//
...
@class CICChartBuilder, CICQuadChartiPadViewController;

@interface CICQuadChartiPadViewController : UIViewController <BluetoothDelegate>{
    //Chart/Plot Handling
    ...
    UILabel *chartLabel3;
    UILabel *chartLabelData3;
    UILabel *chartLabel4;
    UILabel *chartLabelData4;
...
@property (nonatomic, retain) IBOutlet UILabel *chartLabel3;
@property (nonatomic, retain) IBOutlet UILabel *chartLabelData3;
@property (nonatomic, retain) IBOutlet UILabel *chartLabel4;
@property (nonatomic, retain) IBOutlet UILabel *chartLabelData4;
