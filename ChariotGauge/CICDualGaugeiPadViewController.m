//
//  CICDualGaugeiPadViewController.m
//  ChariotGauge
//
...
@implementation CICDualGaugeiPadViewController
...
-(void)createBoostGauge:(CICGaugeBuilder *)gaugeView :(CICCalculateData *)calcData
{
    ...
    gaugeView.needleBuilder.needleScaler = 2.0f;
...
-(void)createVoltGauge
{
    ...
    voltLabel = [[UILabel alloc] initWithFrame:CGRectIntegral(CGRectMake(0.0f, sizeOfScreen.height-84.0f, sizeOfScreen.width, 40.0f))];
    voltLabel.textAlignment = NSTextAlignmentCenter;
    [voltLabel setFont:digitalFont];
    [voltLabel setText:@"Volts"];
    
    voltLabelNumbers = [[UILabel alloc] initWithFrame:CGRectIntegral(CGRectMake(0.0f, sizeOfScreen.height-44.0f, sizeOfScreen.width, 40.0f))];
